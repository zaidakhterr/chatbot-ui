...
AS $$
DECLARE
  project_url TEXT := 'https://fhpanohewurugygfmcrf.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZocGFub2hld3VydWd5Z2ZtY3JmIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwODIzNzYyMCwiZXhwIjoyMDIzODEzNjIwfQ.-mlT2J8dofjHQ_CK2olo-4ibomwNfUzygDz5b_wt8Dg'; -- full access needed for http request to storage
